...
- **main Branch:** Contains the core files required to activate the **CI/CD runner**. This includes the k6 smoke test script and Postman API collection/environment files.
- **Feature Branches:** All detailed documentation and specialized automation suites are maintained on separate branches, including:
  ...
  - **Test Cases Repost**
  - **Bug Reports**: All 9 Identified Bugs
